...
// here we also use destructuring to get values from given object
// we pass ONE argument, ONE object, and we destructuring him according to names inside
...
// and we can also use default values here
restaurant.orderDelivery({
  address: 'Via del Sole, 21',
  starterIndex: 1,
});
